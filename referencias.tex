\begin{thebibliography}{+++}
	...
	\bibitem{irpagnossin-stoa} \url{stoa.usp.br/irpagnossin/files}, item ``Apresentação e relatórios técnicos''.
	
	\bibitem{curso-LaTeX} \url{http://goo.gl/bz6ST} (curso \textsl{Usando \LaTeX; pensando \TeX})
	
	\bibitem{phet} \url{http://phet.colorado.edu/} (projeto PhET).
\end{thebibliography}