...
\documentclass[a4paper,12pt]{scrbook}					% Sub-classe koma-script
  ...
  \usepackage[symbol,norule,flushmargin]{footmisc}
	...
	\subtitle{apresentado para o provimento de um cargo de Professor Doutor junto ao Departamento de Física Experimental do Instituto de Física da Universidade de São Paulo}
