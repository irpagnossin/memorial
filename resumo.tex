...
\begin{compactitem}
	...
	\item \textsl{Processo de Criação de Objetos de Aprendizagem --- Usos do Padrão SCORM}, disciplina do curso de pós-graduação a distância em \foreign{Design} Instrucional do Senac (3--28 de agosto de 2012).
\end{compactitem}
